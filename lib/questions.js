const colorKeywords = require('./colorKeyword.js')
...
const questions = [
    ...
    // color keyword:looping throught the color keyword array
    {
        type: "input",
        name: "shapeColor",
    ...
    // ***TEXT***
    // user can only submit 3 characters
    {
        name: 'text',
        message: 'What text would you like inside your shape? (maximum of 3 characters)',
        type: 'input',
        validate: (answer) => {
            if (answer.length > 3) {
